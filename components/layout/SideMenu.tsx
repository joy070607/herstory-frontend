...
const MENU_SECTIONS: { title: string; items: MenuItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: "여정 타임라인", href: ROUTES.journeyTimeline, Icon: AirplaneOutlineIcon },
      { label: "스타일 추천", href: ROUTES.styleEngine, Icon: AiLogoIcon },
      { label: "스마트 카트", href: ROUTES.smartCart, Icon: DressIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "회원정보 수정", href: ROUTES.myPageEditProfile, Icon: UilPenIcon },
